...
## How to run
```
java -cp target/seasonal-hex-game-1.0-SNAPSHOT.jar trevorah.graphical.GUI
```

Or using Maven directly:
```
mvn exec:java -Dexec.mainClass="trevorah.graphical.GUI"
```

This launches a Swing GUI where you can configure player types (human or AI), board size, and number of seasons (1-3).